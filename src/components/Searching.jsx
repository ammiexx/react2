...
const Searching = ({ products, onFilter, onSubmit }) => {
  ...
  const handleSearch = () => {
    ...
    // Collapse mobile search if provided
  ...
  return (
    <div className="relative w-full flex items-center">
      ...
      <button
        ...
        className="absolute right-1 top-1/2 transform -translate-y-1/2 bg-yellow-400 hover:bg-yellow-500 
                   h-8 w-8 sm:h-10 sm:w-10 flex items-center justify-center rounded-r-full text-white 
