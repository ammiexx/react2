...
const categories = [
  {
    name: 'Food & Beverages',
    image_url: 'https://images.unsplash.com/photo-1614207279966-a46c93c0fbc2?w=600&auto=format&fit=crop&q=60',
  ...
  {
    name: 'Entertainments',
    image_url: 'https://plus.unsplash.com/premium_photo-1683129679874-15966b2c1fdc?w=600&auto=format&fit=crop&q=60',
    path: '/entertainments',
  },
  {
  ...
  },
  {
    ...
    image_url: 'https://plus.unsplash.com/premium_photo-1750449864279-341157c41bc8?q=80&w=870&auto=format',
    path: '/Repair_and_maintenace',
  },
  {
    name: 'Vidoes & Games products',
    image_url: 'https://plus.unsplash.com/premium_photo-1664910795422-527440cfce2d?w=600&auto=format&fit=crop&q=60',
    path: '/Toys_And_Games',
  },
  {
    name: 'Finance & Insurances services',
    image_url: 'https://plus.unsplash.com/premium_photo-1661436432458-f7ca1a171410?w=600&auto=format&fit=crop&q=60',
    path: '/Finance_And_Insurances',
  },
  {
    name: 'Pet Supplies And Services',
    image_url: 'https://plus.unsplash.com/premium_photo-1663133568320-97c8c0d0c4ba?w=600&auto=format&fit=crop&q=60',
    path: '/Pet_Supplies_And_Services',
  },
  {
    name: 'Medical And Pharmaceutical services',
    image_url: 'https://plus.unsplash.com/premium_photo-1666299175827-59ca81fb2666?w=600&auto=format&fit=crop&q=60',
    path: '/Medical_And_Pharmaceuticals',
  },
  {
    name: 'Logistics And Delivery Services',
    image_url: 'https://images.unsplash.com/photo-1754765542024-c1320f23b75a?w=600&auto=format&fit=crop&q=60',
    path: '/Logistics_And_Delivery_Services',
  },
  {
    name: 'Consultancy Services',
    image_url: 'https://images.unsplash.com/photo-1565688527174-775059ac429c?w=600&auto=format&fit=crop&q=60',
    path: '/legal_And_Consultancy_Services',
  },
  {
    name: 'Cleaning And Sanitation materials',
    image_url: 'https://images.unsplash.com/photo-1579141132886-e86d831034ac?w=600&auto=format&fit=crop&q=60',
    path: '/Cleaning_And_Sanitation_Services',
  },
  {
    name: 'Telecom Services',
    image_url: 'https://images.unsplash.com/photo-1697097156924-de4efa72afc8?w=600&auto=format&fit=crop&q=60',
    path: '/Telecome_Services',
  },
  {
    name: 'Software & IT Services',
    image_url: 'https://images.unsplash.com/photo-1598316560453-0246d4611979?w=600&auto=format&fit=crop&q=60',
    path: '/SoftWare_And_IT_Services',
  },
  {
    name: 'Digital Security services',
    image_url: 'https://images.unsplash.com/photo-1639503547276-90230c4a4198?w=600&auto=format&fit=crop&q=60',
    path: '/Security_Services',
  },
  {
    name: 'Automotive Services',
    image_url: 'https://plus.unsplash.com/premium_photo-1661299233465-ad4268ddb448?w=600&auto=format&fit=crop&q=60',
    path: '/Automotive_Services',
  },
  {
    name: 'Elderly & Nursing Services',
    image_url: 'https://images.unsplash.com/photo-1581056771107-24ca5f033842?w=600&auto=format&fit=crop&q=60',
    path: '/Elderly_And_Nursing_Services',
  },
  {
    name: 'Rental Services',
    image_url: 'https://plus.unsplash.com/premium_photo-1661761197559-58493b11151b?w=600&auto=format&fit=crop&q=60',
