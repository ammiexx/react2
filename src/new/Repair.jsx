  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        data = data.filter(
          (item) => item.category === 'repair' && item.verified === true
        );
  ...
  return (
    <div className="max-w-[1200px] mx-auto my-10 px-5 text-[#2c3e50] font-sans w-full">
      <label htmlFor="search" className="text-xl font-bold mb-3 text-center">
            🎯 <strong>Fix it right, fix it once — shop trusted repair essentials today 🔧🛠️</strong> 👀 💡
          </label>
      ...
      <section className="mb-12 w-full">
        ...
        {loading ? (
          ...
          <p className="text-center text-gray-500">
            No repair and maintenance found.
          </p>
        ) : (
