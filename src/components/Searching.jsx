...
const Searching = ({ products, onFilter, onSubmit }) => {
  ...
  return (
   <div className="relative w-full max-w-[400px] sm:max-w-[500px] md:max-w-[600px] flex items-center">
  <input
    type="text"
    value={searchTerm}
    ...
    className="flex-1 h-11 text-sm text-gray-900 placeholder-gray-500 bg-white rounded-full pl-4 pr-12 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 shadow-md transition-all"
  />
  <button
    type="button"
