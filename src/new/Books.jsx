  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Filter for category "books" and verified = true
        data = data.filter(
          (item) => item.category === 'books' && item.verified === true
        );
  ...
  return (
    <div className="max-w-[1200px] mx-auto my-10 px-5 text-[#2c3e50] font-sans w-full">
      <h2 className="text-2xl font-bold text-center text-gray-800 mb-6">
        📖 Fuel your mind & organize your life — shop books & stationery that inspire ✨
      </h2>
