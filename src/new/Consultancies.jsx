...
const Nearby = () => {
      ...
      navigator.geolocation.getCurrentPosition(
        async (pos) => {
          ...
          try {
            ...
            data = data.filter(
              (item) => item.category === 'consultancy' && item.verified === true
            );
 ...
 <label htmlFor="search" className="text-xl font-bold mb-3 text-center">
            🎯 <strong>Get expert advice that moves your vision forward — connect with trusted consultants today 📈🤝:</strong> 👀 💡
          </label>
      <section className="mb-12 w-full">
        ...
        {loading ? (
          ...
          <p className="text-center text-gray-500">No consultancy services found.</p>
        ) : (
