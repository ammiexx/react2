...
const Nearby = () => {
      ...
      navigator.geolocation.getCurrentPosition(
        async (pos) => {
          ...
          try {
            ...
            data = data.filter(
              (item) => item.category === 'land' && item.verified === true
            );
 ...
 <label htmlFor="search" className="text-xl font-bold mb-3 text-center">
            🎯 <strong>Transform your outdoors — shop top landscaping & gardening tools to grow your dream space 🌿</strong> 👀 💡
          </label>
      <section className="mb-12 w-full">
        ...
        {loading ? (
          ...
          <p className="text-center text-gray-500">No gardening products and services found.</p>
        ) : (
