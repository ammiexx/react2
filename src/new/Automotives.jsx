  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Filter for category "automotive" and verified = true
        data = data.filter(
          (item) => item.category === 'automotive' && item.verified === true
        );
  ...
  return (
    <div className="max-w-[1200px] mx-auto my-10 px-5 text-[#2c3e50] font-sans w-full">
      ...
      <section className="mb-12 w-full">
        ...
        {loading ? (
          // Skeleton Loader (cleaner than bouncing dots)
          ...
          <p className="text-center text-gray-500">
            No automotive services or products found.
          </p>
        ) : (
