  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Filter for category "art" and verified = true
        data = data.filter(
          (item) => item.category === 'art' && item.verified === true
        );
  ...
  return (
    <div className="max-w-[1200px] mx-auto my-10 px-5 text-[#2c3e50] font-sans w-full">
      ...
      <section className="mb-12 w-full">
        ...
        {loading ? (
          // Skeleton Loader (consistent with other categories)
          ...
          <p className="text-center text-gray-500">No art products found.</p>
        ) : (
