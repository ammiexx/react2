...
const Search = () => {
  ...
  return (
    <>
      {/* Top Navigation */}
   {/* Top Navigation */}
<nav className="w-full bg-white border-b border-gray-200 text-gray-800 shadow-sm flex items-center px-1 py-1 gap-5 font-sans whitespace-nowrap overflow-x-hidden">
  {/* Hamburger Icon */}
